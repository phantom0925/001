...
def main():
    # 指定redis数据库信息
    rediscli = redis.StrictRedis(host='192.168.18.129', port = 6379, db = 0)
    # 指定mysql数据库
    mysqlcli = MySQLdb.connect(host='localhost', user='mysql', passwd='xxxxxxx', db = 'bjzufang', port=3306, use_unicode=True)
